...
- Switch to superpowers-using-git-worktrees
...
- Switch to superpowers-writing-plans skill
...
**During exploration:**
- When approaches have genuine trade-offs: superpowers-preserving-productive-tensions

**Before proposing changes to existing code:**
- Understand why it exists: superpowers-tracing-knowledge-lineages
