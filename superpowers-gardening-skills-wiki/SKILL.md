...
```bash
# Run all checks
~/.claude/superpowers-gardening-skills-wiki/garden.sh

# Or run specific checks
~/.claude/superpowers-gardening-skills-wiki/check-links.sh
~/.claude/superpowers-gardening-skills-wiki/check-naming.sh
~/.claude/superpowers-gardening-skills-wiki/check-index-coverage.sh

# Analyze search gaps (what skills are missing)
~/.claude/superpowers-gardening-skills-wiki/analyze-search-gaps.sh
```
...
```
❌ BROKEN: superpowers-root-cause-tracing
   Target: /path/to/superpowers-root-cause-tracing skill
```
...
```
❌ BACKTICKED: superpowers-condition-based-waiting on line 31
...
**Usage:**
```bash
~/.claude/superpowers-gardening-skills-wiki/garden.sh [skills_dir]
```
