...
```bash
cd ~/.claude/superpowers-remembering-conversations/tool
...
ls -l ~/.claude/superpowers-remembering-conversations/tool/index-conversations
...
**For searching conversations from within Claude Code sessions**, use the subagent pattern (see `superpowers-using-skills` for complete workflow).
...
└── superpowers-remembering-conversations/
