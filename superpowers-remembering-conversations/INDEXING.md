...
```bash
~/.claude/superpowers-remembering-conversations/tool/install-hook
```

**Index all conversations:**
```bash
~/.claude/superpowers-remembering-conversations/tool/index-conversations
```

**Process unindexed only:**
```bash
~/.claude/superpowers-remembering-conversations/tool/index-conversations --cleanup
```
