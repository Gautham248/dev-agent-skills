...
- superpowers-requesting-code-review (review template)
- superpowers-test-driven-development (subagents follow this)

**Alternative to:**
- superpowers-executing-plans (parallel session)

See code-reviewer template: superpowers-requesting-code-review/code-reviewer.md
