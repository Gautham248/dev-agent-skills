...
- "Session-start showed it to me" - That was superpowers-using-skills skill only. Read the actual skill.
...
**Examples:** superpowers-test-driven-development skill, superpowers-systematic-debugging skill, superpowers-writing-skills skill
