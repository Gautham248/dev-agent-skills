...
```
Use superpowers-condition-based-waiting skill when tests have race conditions, timing dependencies, or pass/fail inconsistently
```
...
- ✅ `superpowers-using-skills` not `skill-usage`
...
- ❌ Bad: `@superpowers-test-driven-development skill` (force-loads, burns context)
...
See superpowers-test-driven-development for why this matters. Same principles apply to documentation.
